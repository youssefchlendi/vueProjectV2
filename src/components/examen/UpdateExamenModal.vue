<template>
  <div class="updateExamen">
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="editExamenLabel"
      aria-hidden="true"
    >
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <select v-model="idMatiere">
              <option
                v-for="matiere in Matiere"
                :selected="matiere.id == idMatiere"
                :key="matiere.id"
                :value="matiere.id"
              >
                {{ matiere.intitule }}
...
export default {
  ...
  methods: {
    ...
    getOne(id) {
      ...
      let tab = {};
      axios
        .get("http://localhost:8085/api/examen/read_one.php?id=" + id)
    ...
    updateData() {
      this.$emit("update-data", {
        ...
        coefficient:
          this.coefficient != null ? parseFloat(this.coefficient) : null,
      });
      this.id = null;
      this.idMatiere = null;
      this.idProf = null;
      ...
      axios
        ...
        .then(() => {
          Object.keys(this.Matiere).forEach((key) =>
            this.Matiere[key].forEach((key) => tab.push(key))
          );
        })
        .then(() => {
          this.Matiere = tab;
