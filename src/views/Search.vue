<template>
  <div class="search m-4" style="margin-bottom: 250px !important">
    ...
    <p class="text-center">
      <button class="btn btn-success p-2 m-2" type="button" @click="showCol(1)">
        Classes
      </button>
      <button class="btn btn-success p-2 m-2" type="button" @click="showCol(2)">
        Enseignant
      </button>
      <button class="btn btn-success p-2 m-2" type="button" @click="showCol(3)">
        Etudients
      </button>
      <button class="btn btn-success p-2 m-2" type="button" @click="showCol(4)">
        Matiere
      </button>
      <button class="btn btn-success p-2 m-2" type="button" @click="showCol(5)">
        Examens
      </button>
      <button class="btn btn-success p-2 m-2" type="button" @click="showAll">
        All
      </button>
    </p>
...
export default {
  ...
  methods: {
    getClasses() {
      let stat;
      axios
        .get("http://localhost:8085/api/class/search.php?s=" + this.search)
        .then((response) => {
    ...
    getEnseignants() {
      let stat;
      axios
        .get("http://localhost:8085/api/enseignant/search.php?s=" + this.search)
        .then((response) => {
    ...
    getEtudient() {
      let stat;
      axios
        .get("http://localhost:8085/api/etudient/search.php?s=" + this.search)
        .then((response) => {
    ...
    getMatiere() {
      let stat;
      axios
        .get("http://localhost:8085/api/matiere/search.php?s=" + this.search)
        .then((response) => {
    ...
    getExamen() {
      let stat;
      axios
        .get("http://localhost:8085/api/examen/search.php?s=" + this.search)
        .then((response) => {
