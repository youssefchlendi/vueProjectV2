...
// query Etudients
$stmt = $Etudient->readPaging($from_record_num, $records_per_page);
$num = $stmt->rowCount();
...
if($num>0){
    ...
    // include paging
    $total_rows=$Etudient->count();
    $page_url="{$home_url}Etudient/read_paging.php?";
    $paging=$utilities->getPaging($page, $total_rows, $records_per_page, $page_url);
    $Etudients_arr["paging"]=$paging;
    ...
    // tell the user Etudients does not exist
    echo json_encode(
